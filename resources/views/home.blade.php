                            ...
                            <div class="card" style="width: 150px;">
                                <div class="card-content">
                                    ...
                                    <a href="{{ route('roles.index') }}" class="btn btn-custom"
                                        style="border-radius: 4px; background-color: rgba(240, 140, 210, 0.7);">
                                        </i></i> <button type="button" class="btn btn-default"> Gerencie seu Perfil</button>
                                    </a>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <div class="media d-flex p-1 m-2 md:m-8">
                                        ...
                                        <div
                                            class="media-body text-right color-white; font-weight: bold;border-width: 10px; border-style: solid; border-color: #e24ab4; border-radius: 8px; ">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-content">
                                <div class="card-body ">
                                    ...
                                    <a href="{{ route('agendamentos.index') }}" class="btn btn-custom"
                                        style="border-radius: 4px; background-color: rgba(240, 140, 210, 0.7);">
                                         <button type="button" class="btn btn-default"> Gerencie seu Agendamento
                                        </button> 
                                    </a>
                            </div>
                        </div>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('cad_doadoras.index') }}" class="btn btn-custom"
                                        style="border-radius: 4px; background-color: rgba(240, 140, 210, 0.7);">
                                        </i></i> <button type="button" class="btn btn-default"> Gerencie Doadora </button> 
                                    </a>
                            </div>
                        </div>
                    </div>
